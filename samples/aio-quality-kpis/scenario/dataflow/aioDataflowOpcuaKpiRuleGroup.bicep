param ruleGroupPrefix string = 'DataflowOpcua'
...
param rules KpiRule[] = [
  ...
  {
    ruleType: 'KpiSignal'
    outputMetric: 'aio_signal_scenario_dataflow_opcua_mqtt_publish_success_rate'
    promQL: '''
  ...
  }
  {
    ...
    outputMetric: 'aio_health_scenario_dataflow_opcua_mqtt_publish_success_rate'
    kpi: 'aio.scenario.dataflow.opcua.mqtt.publish.successrate'
    promQL: 'sgn(floor(min by(cluster, namespace)(aio_signal_scenario_dataflow_opcua_mqtt_publish_success_rate) / 0.99999))'
  }
  // Signal and HealthState KPIs for OPC-UA connect success rate:
  {
    ruleType: 'KpiSignal'
    outputMetric: 'aio_signal_scenario_dataflow_opcua_connect_success_rate'
    promQL: '''
  ...
  {
    ruleType: 'KpiHealthState'
    outputMetric: 'aio_health_scenario_dataflow_opcua_connect_success_rate'
    kpi: 'aio.scenario.dataflow.opcua.connect.successrate'
    promQL: 'sgn(floor(min by(cluster, namespace)(aio_signal_scenario_dataflow_opcua_connect_success_rate) / 0.99999))'
  }
  // Signal and HealthState KPIs for OPC-UA latency for MQTT publishing:
  {
    ruleType: 'KpiSignal'
    outputMetric: 'aio_signal_scenario_dataflow_opcua_mqtt_publish_latency'
    promQL: '''
  ...
  {
    ruleType: 'KpiHealthState'
    outputMetric: 'aio_health_scenario_dataflow_opcua_mqtt_publish_latency'
    kpi: 'aio.scenario.dataflow.opcua.mqtt.publish.latency'
    promQL: '1 - sgn(floor(min by(cluster, namespace)(aio_signal_scenario_dataflow_opcua_mqtt_publish_latency) / 5000))'
  }
  // Signal and HealthState KPIs for OPC-UA connect latency:
  {
    ruleType: 'KpiSignal'
    outputMetric: 'aio_signal_scenario_dataflow_opcua_connect_latency'
    promQL: '''
  ...
  {
    ruleType: 'KpiHealthState'
    outputMetric: 'aio_health_scenario_dataflow_opcua_connect_latency'
    kpi: 'aio.scenario.dataflow.opcua.connect.latency'
    promQL: '1 - sgn(floor(min by(cluster, namespace)(aio_signal_scenario_dataflow_opcua_connect_latency) / 5000))'
  }
  // Rollup KPI for OPC-UA health:
  {
    ruleType: 'KpiHealthStateRollup'
    outputMetric: 'aio_health_scenario_dataflow_opcua'
    kpi: 'aio.scenario.dataflow.opcua'
    promQL: '''
      min by(cluster, namespace) (
        aio_health_scenario_dataflow_opcua_mqtt_publish_success_rate or
        aio_health_scenario_dataflow_opcua_connect_success_rate or
        aio_health_scenario_dataflow_opcua_mqtt_publish_latency or
        aio_health_scenario_dataflow_opcua_connect_latency or
